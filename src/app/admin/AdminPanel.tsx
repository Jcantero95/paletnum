          ...
          rechazando === p.id ? (
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={isPending}
                  className="flex-1 text-xs bg-red-500 text-white px-3 py-2 rounded-lg font-medium hover:opacity-90 transition-opacity"
                >
                  Confirmar rechazo
                </button>
              </div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={isPending}
                className="flex-1 text-xs bg-accent3 text-white px-3 py-2 rounded-lg font-medium hover:opacity-90 transition-opacity"
              >
                ✓ Aprobar
              </button>
            </div>
